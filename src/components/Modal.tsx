...
const Modal: React.FC<ModalProps> = ({ children }) => {
  return (
    <div
      ...
      className="absolute top-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] flex justify-center content-center flex-wrap backdrop-blur-md"
    >
